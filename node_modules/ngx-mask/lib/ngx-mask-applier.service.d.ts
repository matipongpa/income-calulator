...
export declare class NgxMaskApplierService {
    ...
    showTemplate: NgxMaskConfig['showTemplate'];
    ...
    applyMaskWithPattern(inputValue: string, maskAndPattern: [string, NgxMaskConfig['patterns']]): string;
    ...
    private _findFirstNonZeroDigitIndex;
